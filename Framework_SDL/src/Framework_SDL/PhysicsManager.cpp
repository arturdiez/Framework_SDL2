...
unsigned long PhysicsManager::RegisterObject(PhysObject* object, CollisionLayers layer) {

	mCollisionLayers[static_cast<unsigned int>(layer)].push_back(object);
...
void PhysicsManager::UnregisterObject(unsigned long id) {
